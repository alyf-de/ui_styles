...
from ui_styles.desk_background.boot import allow_user_color_enabled, feature_enabled, get_site_settings
from ui_styles.desk_background.install import USER_CUSTOM_FIELD, USER_INTENSITY_FIELD
from ui_styles.desk_background.presets import is_valid_intensity, is_valid_preset
...
def validate_user_desk_color(doc, method=None):
	...
	if not feature_enabled(settings) or not allowed:
		if preset:
